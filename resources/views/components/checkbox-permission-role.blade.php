            ...
            :attributes="
                \Filament\Support\prepare_inherited_attributes($attributes)
                    ...
                    ->class([
                        ...
                        '-mt-8' => $gridDirection === 'column',
                    ])
            "
        >
            @forelse ($getOptions() as $groupName => $groups)
                <label
                    class="fi-fo-checkbox-list-option-label font-bold text-gray-950 dark:text-white">{{$groupName}}</label>
                <div class="border border-gray-200 dark:border-white rounded p-2">
